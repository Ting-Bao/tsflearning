...
def batch_file_output(poscar, super, shift, type, num_pert, pert, num_atom_each_layer, shift_which_layer, basis_accu, soc, dftu, dftuval, magmom, widespace = False):
    ...
    sigma = 0.1 # specially, beyond 2 sigma will be dropped in the sampling       
...
#'/home/tbao/soft/opmx_basis.txt'#'/u/nikp/soft/openmx3.9/opmx_basis.txt'
np.random.seed(42)  # set random seed

if __name__=="__main__":

    # os.chdir('./dataset_new_k331_widespace/')
